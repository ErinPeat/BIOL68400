...
print ('This data frame is this many row + columns' , data.shape  , 'and has the following column headers', list(data.columns) ,
#Gives the user an output of what the data frame looks like and the headers, so they can get these are as expected
